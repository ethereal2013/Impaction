...
static inline ImGui_ImplOpenGL3_RenderState* ImGui_ImplOpenGL3_GetRenderState() { return static_cast<ImGui_ImplOpenGL3_RenderState*>(ImGui::GetPlatformIO().Renderer_RenderState); }
